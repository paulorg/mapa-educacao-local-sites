<?php
	function register_local_sites_post() {
		$labels = array(
			...
			'featured_image'        => __( 'Foto da unidade', 'mapa-educacao' ),
			'set_featured_image'    => __( 'Enviar foto', 'mapa-educacao' ),
			'remove_featured_image' => __( 'Remover foto', 'mapa-educacao' ),
			'use_featured_image'    => __( 'Usar como foto', 'mapa-educacao' ),
